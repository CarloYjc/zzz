...
public class WebUtils {
     ...
     */
    /*
     * public static void ajaxJson(HttpServletResponse response, Integer code,
     * String msg) throws Exception { String json = JsonUtils.objectToJson(new
     * ResultUtil(code, msg)); response.setContentType("text/json; charset=utf-8");
     * response.setHeader("Cache-Control", "no-cache"); // 取消浏览器缓存 PrintWriter out =
     * response.getWriter(); out.print(json); out.flush(); out.close(); }
     */
}
