...
<link rel="stylesheet" href="${ctx }/css/main.css?3" media="all" />
<script>  
    var ctx = "${ctx}";  
</script> 
</head>
<body class="main_body">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="javascript:;" class="mobileAddTab" data-url="${ctx }/sys/changePwd">
			    			<i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i>
			    			<cite>修改密码</cite>
		    			</a>
			    	</li>
			    	<li class="layui-nav-item" mobile>
			    		<a href="${ctx }/sys/loginOut" class="signOut">
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-url="${ctx }/sys/changePwd">
									<i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i>
									<cite>修改密码</cite>
								</a>
							</dd>
	...
	<script type="text/javascript" src="${ctx }/js/modules/index.js"></script>
</body>
</html>